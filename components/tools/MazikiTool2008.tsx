  ...
  return (
    <div>
      <div style={{ marginBottom: "0.5rem", fontSize: "0.85rem", color: "var(--text-muted)" }}>
        ...
        <span style={{ color: "var(--danger)", fontWeight: 700, textDecoration: "underline" }}>        </span>
      </div>
      <textarea
      ...
      <div style={{ display: "flex", gap: "0.5rem", flexWrap: "wrap", marginTop: "0.75rem", marginBottom: "1.5rem" }}>
        ...
        {done && selected.size > 0 && (
          <>
            <button className="btn" onClick={() => exportData("excel")} style={{ background: "var(--success)", color: "white", border: "none" }}>📊 Excel ({selected.size})</button>
      ...
      {done && (
        <>
          ...
          <div className="card" style={{ padding: 0, overflow: "hidden" }}>
            {/* Header */}
            <div style={{ display: "grid", gridTemplateColumns: "32px 1fr 1fr 110px", gap: "0.5rem", alignItems: "center", padding: "0.75rem 1rem", background: "var(--info-text)", color: "white", fontSize: "0.78rem", fontWeight: 700 }}>
