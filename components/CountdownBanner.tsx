...
export default function CountdownBanner() {
  ...
  if (!time) return (
    <div style={{ background: "var(--danger)", color: "white", borderRadius: "var(--radius)", padding: "1rem 1.5rem", textAlign: "center", fontWeight: 700, marginBottom: "2rem" }}>
      ⚠️ Η προθεσμία της 30ής Οκτωβρίου 2026 έχει παρέλθει.
    </div>
  );
  ...
  return (
    <div style={{ background: "linear-gradient(135deg, #7c2d12, #dc2626)", color: "white", borderRadius: "var(--radius)", padding: "1.25rem 1.5rem", display: "flex", alignItems: "center", gap: "1rem", flexWrap: "wrap", marginBottom: "2rem" }}>
      ...
      <a href="https://myaade.gov.gr" target="_blank" rel="noopener noreferrer" style={{ background: "white", color: "var(--danger)", padding: "0.65rem 1.2rem", borderRadius: 8, fontWeight: 700, textDecoration: "none", whiteSpace: "nowrap", flexShrink: 0 }}>
        myAADE →
      </a>
    </div>
  );
