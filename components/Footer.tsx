...
export default function Footer() {
  return (
    <footer style={{ background: "var(--primary-dark)", color: "rgba(255,255,255,0.8)", padding: "2rem 1rem", marginTop: "3rem", minHeight: "420px", contain: "layout" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "1.5rem", marginBottom: "1.5rem" }}>
          ...
          <div>
            <div style={{ fontWeight: 800, fontSize: "1.1rem", color: "white", marginBottom: "0.5rem" }}>
              <span style={{ color: "var(--accent-light)" }}>ΚΑΔ</span>2025.gr
            </div>
          ...
          <div>
            ...
            <div style={{ background: "rgba(255,255,255,0.08)", border: "1px solid rgba(255,255,255,0.15)", borderRadius: 8, padding: "0.6rem 0.75rem", fontSize: "0.78rem", color: "rgba(255,255,255,0.6)", lineHeight: 1.5 }}>
              ...
              <strong style={{ color: "rgba(255,255,255,0.85)" }}>30 Οκτωβρίου 2026</strong>.{" "}
