...
export default function AISuggesterPage() {
  return (
    <div style={{ maxWidth: 800, margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      <div style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", background: "linear-gradient(135deg, #7c3aed20, #1e3a5f20)", border: "1px solid #7c3aed40", borderRadius: 20, padding: "0.3rem 0.9rem", fontSize: "0.8rem", fontWeight: 700, marginBottom: "1rem", color: "var(--acc-purple)" }}>
        ✨ AI-Powered — Νέο
      </div>
