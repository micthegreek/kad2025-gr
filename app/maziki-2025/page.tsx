...
export default function Maziki2025Page() {
  ...
  return (
    <div style={{ maxWidth: 900, margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      <div style={{ background: "var(--warn-bg)", border: "1px solid var(--warn-border)", borderRadius: "var(--radius)", padding: "0.75rem 1rem", fontSize: "0.82rem", color: "var(--warn-text)", marginBottom: "1rem" }}>
