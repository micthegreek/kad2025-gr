...
export default function KadEpidotisiPage() {
  return (
    <div style={{ maxWidth: 860, margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      <div style={{ background: "var(--warn-bg)", border: "1px solid var(--warn-border)", borderRadius: "var(--radius)", padding: "0.75rem 1rem", fontSize: "0.82rem", color: "var(--warn-text)", marginTop: "2rem" }}>
        ...
        <a href="mailto:info@kad2025.gr" style={{ color: "var(--warn-strong)", fontWeight: 600 }}>info@kad2025.gr</a>.
      </div>
