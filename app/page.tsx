...
const tools = [
  { href: "/kad-2008", icon: "📋", title: "Αναζήτηση ΚΑΔ 2008", desc: "Αναζητήστε παλιούς κωδικούς δραστηριότητας", color: "var(--acc-blue)", badge: "Παλιοί ΚΑΔ", highlight: false },
  { href: "/kad-2025", icon: "🆕", title: "Αναζήτηση ΚΑΔ 2025", desc: "Νέοι κωδικοί που ισχύουν από 1/3/2026", color: "var(--acc-green)", badge: "Νέοι ΚΑΔ", highlight: false },
  { href: "/antistoixisi", icon: "🔄", title: "Αντιστοίχιση ΚΑΔ 2008 → 2025", desc: "Βρείτε ποιος νέος ΚΑΔ 2025 αντικαθιστά τον παλιό σας", color: "var(--acc-purple)", badge: "2008 → 2025", highlight: true },
  { href: "/antistoixisi-2025", icon: "🔄", title: "Αντιστοίχιση ΚΑΔ 2025 → 2008", desc: "Βρείτε ποιος παλιός ΚΑΔ 2008 αντιστοιχεί στον νέο", color: "var(--acc-cyan)", badge: "2025 → 2008", highlight: true },
  { href: "/enarxi-epixeirisis-kad", icon: "🚀", title: "ΚΑΔ Έναρξης Επιχείρησης", desc: "Βρείτε τον ΚΑΔ που πρέπει να δηλώσετε στην εφορία για νέα επιχείρηση", color: "var(--acc-green)", badge: "Νέα Επιχείρηση", highlight: false },
  { href: "/maziki-2008", icon: "📦", title: "Μαζική Αντιστοίχιση 2008 → 2025", desc: "Λίστα παλιών ΚΑΔ → ομαδική αντιστοίχιση σε Excel & CSV", color: "var(--acc-amber)", badge: "Για Λογιστές", highlight: false },
  { href: "/maziki-2025", icon: "📦", title: "Μαζική Αντιστοίχιση 2025 → 2008", desc: "Λίστα νέων ΚΑΔ → εύρεση παλιών κωδικών σε Excel & CSV", color: "var(--acc-amber)", badge: "Για Λογιστές", highlight: false },
  { href: "/ai-suggester", icon: "✨", title: "AI Βοηθός ΚΑΔ", desc: "Περιγράψτε τη δραστηριότητά σας και το AI σας προτείνει τον σωστό ΚΑΔ", color: "var(--acc-purple)", badge: "AI", highlight: true },
...
const stats = [
  { label: "Εγγραφές Αντιστοίχισης", value: "10.925", icon: "📊" },
  { label: "Μοναδικοί ΚΑΔ 2008", value: "9.717", icon: "📂" },
  { label: "Μοναδικοί ΚΑΔ 2025", value: "9.424", icon: "🆕" },
  { label: "Αλλαγμένοι ΚΑΔ", value: "7.240", icon: "🔄" },
];

const faqs = [
  { q: "Πώς βρίσκω τον νέο ΚΑΔ 2025 της επιχείρησής μου;", a: "Χρησιμοποιήστε το εργαλείο αντιστοίχισης: πληκτρολογήστε τον παλιό ΚΑΔ 2008 και λαμβάνετε άμεσα τον νέο ΚΑΔ 2025. Έχετε έως 30/10/2026 να διορθώσετε τυχόν λάθη χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026)." },
  ...
  { q: "Τι γίνεται αν δεν αλλάξω ΚΑΔ;", a: "Η ΑΑΔΕ ολοκλήρωσε αυτόματη αντιστοίχιση στις 9 Μαρτίου 2026. Αν δεν συμφωνείτε με το αποτέλεσμα, διορθώστε έως 30/10/2026 χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026)." },
      ...
      <section style={{ background: "linear-gradient(135deg, var(--primary-dark) 0%, var(--primary) 100%)", color: "white", padding: "3rem 1rem", textAlign: "center" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
            <Link href="/antistoixisi" style={{ background: "var(--accent-light)", color: "#1a1a1a", padding: "0.9rem 2rem", borderRadius: 10, fontWeight: 700, fontSize: "1rem", textDecoration: "none" }}>
              🔄 ΚΑΔ 2008 → 2025
            </Link>
          ...
          {tools.map((t) => (
            <Link key={t.href} href={t.href} className="tool-card" style={{ borderTop: `3px solid ${t.color}` }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "start", marginBottom: "0.75rem" }}>
                ...
                <span style={{ fontSize: "0.7rem", fontWeight: 700, padding: "0.2rem 0.5rem", borderRadius: 20, background: `color-mix(in srgb, ${t.color} 14%, transparent)`, color: t.color, border: `1px solid color-mix(in srgb, ${t.color} 35%, transparent)` }}>{t.badge}</span>
              </div>
