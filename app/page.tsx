...
const faqs = [
  { q: "Πώς βρίσκω τον νέο ΚΑΔ 2025 της επιχείρησής μου;", a: "Χρησιμοποιήστε το εργαλείο αντιστοίχισης: πληκτρολογήστε τον παλιό ΚΑΔ 2008 και λαμβάνετε άμεσα τον νέο ΚΑΔ 2025. Έχετε έως 30/10/2026 να διορθώσετε τυχόν λάθη χωρίς πρόστιμο." },
