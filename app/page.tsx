...
const faqs = [
  ...
  { q: "Τι γίνεται αν δεν αλλάξω ΚΑΔ;", a: "Η ΑΑΔΕ ολοκλήρωσε αυτόματη αντιστοίχιση στις 9 Μαρτίου 2026. Αν δεν συμφωνείτε με το αποτέλεσμα, διορθώστε έως 30/10/2026 χωρίς πρόστιμο." },
