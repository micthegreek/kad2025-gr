...
export const metadata: Metadata = {
  title: "ΚΑΔ 2025 Excel: Δωρεάν Πίνακας 10.925 Γραμμών",
  description:
    "Κατεβάστε δωρεάν τον πλήρη πίνακα ΚΑΔ 2025 σε Excel: 10.925 αντιστοιχίσεις ΚΑΔ 2008 → 2025 με περιγραφές και κατάσταση αλλαγής. Επίσημα δεδομένα ΑΑΔΕ Α.1003/2026 & Α.1004/2026.",
  alternates: { canonical: "https://www.kad2025.gr/kad-2025-excel" },
  openGraph: {
    title: "ΚΑΔ 2025 σε Excel — Δωρεάν Λήψη Πλήρους Πίνακα",
    description: "10.925 αντιστοιχίσεις ΚΑΔ 2008 → 2025 σε μορφοποιημένο Excel με φίλτρα. Δωρεάν, χωρίς εγγραφή.",
  },
};
...
const faqItems = [
  {
    ...
    a: "Ναι, εντελώς δωρεάν και χωρίς εγγραφή ή email. Το αρχείο περιέχει και τις 10.925 εγγραφές του επίσημου πίνακα αντιστοίχισης της ΑΑΔΕ (Α.1004/2026), μορφοποιημένες με φίλτρα και σταθερή γραμμή τίτλων.",
  },
  {
    q: "Πόσο ενημερωμένο είναι το αρχείο;",
    a: "Η τρέχουσα έκδοση δημιουργήθηκε στις 10 Ιουνίου 2026 και αποτυπώνει τον πίνακα των αποφάσεων Α.1003/2026 και Α.1004/2026, μαζί με τη νέα προθεσμία διόρθωσης (30 Οκτωβρίου 2026, Α.1118/2026). Αν οι αποφάσεις τροποποιηθούν, το αρχείο επανεκδίδεται.",
  },
  {
...
const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      description:
        "Πλήρης πίνακας 10.925 αντιστοιχίσεων κωδικών αριθμών δραστηριότητας (ΚΑΔ) από το σύστημα 2008 στο σύστημα 2025 (NACE Rev.2.1), βάσει των αποφάσεων ΑΑΔΕ Α.1003/2026 και Α.1004/2026.",
      url: "https://www.kad2025.gr/kad-2025-excel",
  ...
  return (
    <div style={{ maxWidth: 860, margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      <div className="tldr">
        ...
        10.925 γραμμές με κωδικούς, επίσημες περιγραφές και ένδειξη «Άλλαξε / Αμετάβλητος»,
      ...
      <p>Οι «νέοι ΚΑΔ 2026» είναι οι ίδιοι κωδικοί ΚΑΔ 2025 που ισχύουν από 1/3/2026 — το Excel περιλαμβάνει και τις 10.925 αντιστοιχίσεις, με τις περιγραφές NACE Rev.2.1, έτοιμο για φίλτρα και αναζήτηση.</p>
      <h2 style={{ fontSize: "1.15rem", marginBottom: "0.5rem" }}>kad-2025-antistoixisi.xlsx</h2>
        <p style={{ fontSize: "0.85rem", color: "var(--text-muted)", marginBottom: "1rem" }}>
          631 KB · 10.925 γραμμές · 2 φύλλα εργασίας · Excel 2010+ / LibreOffice / Google Sheets
        </p>
        <a
      ...
      <div className="card" style={{ marginBottom: "1.5rem" }}>
        ...
        <p style={{ fontSize: "0.9rem", lineHeight: 1.8, marginBottom: "0.85rem" }}>
          ...
          Περιλαμβάνει και τις 10.925 εγγραφές του επίσημου πίνακα — μαζί με τις 685 περιπτώσεις
