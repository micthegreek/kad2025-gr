...
const STEPS = [
  ...
  },
  {
    ...
    desc: "Αν η αυτόματη αντιστοίχιση δεν είναι σωστή, διορθώστε μέσω «Μεταβολή Εργασιών» στο myAADE ή με έντυπο Δ211. Έως 30 Οκτωβρίου 2026 χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026).",
  },
];
        ...
        <div className="card" style={{ borderLeft: "4px solid var(--success)" }}>
          <div style={{ display: "flex", flexDirection: "column", gap: "0.6rem" }}>
            {[
              ...
              "Ολοκλήρωση έως 30 Οκτωβρίου 2026 (χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026))",
            ].map((item, i) => (
