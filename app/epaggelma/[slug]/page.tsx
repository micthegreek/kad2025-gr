...
export default async function ProfessionPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      a: "Έως τις 30 Οκτωβρίου 2026 (απόφαση ΑΑΔΕ Α.1118/2026), μέσω της εφαρμογής «Μεταβολή Εργασιών» στο myAADE ή με έντυπο Δ211 μέσω «Τα Αιτήματά μου».",
    },
    {
    ...
    <div style={{ maxWidth: 900, margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      <div className="card" style={{ marginBottom: "1.5rem" }}>
        ...
        <ol style={{ paddingLeft: "1.25rem", lineHeight: 2, fontSize: "0.9rem" }}>
          ...
          <li><strong>Διορθώστε έως 30/10/2026</strong> χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026), μέσω «Μεταβολή Εργασιών» — και ενημερώστε λογιστή, τιμολογιακό πρόγραμμα και ΓΕΜΗ.</li>
        </ol>
      </div>
