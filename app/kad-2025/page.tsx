...
export const metadata: Metadata = {
  title: "Νέοι ΚΑΔ 2025: Πλήρης Λίστα & Αναζήτηση των 9.424 Κωδικών",
  description:
    "Λίστα & αναζήτηση νέων ΚΑΔ 2025 (νέοι ΚΑΔ 2026 ΑΑΔΕ). 9.424 κωδικοί σε ισχύ από 1/3/2026 βάσει NACE Rev.2.1. Βρείτε οποιοδήποτε κωδικό με αριθμό ή λέξη.",
  ...
  openGraph: {
    ...
    description: "9.424 νέοι ΚΑΔ 2025 σε ισχύ από 1 Μαρτίου 2026. Instant αναζήτηση.",
  },
};
