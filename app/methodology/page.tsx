  ...
  return (
    <div style={{ maxWidth: 860, margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      <p style={{ color: "var(--text-muted)", fontSize: "0.9rem", marginBottom: "2rem" }}>
        Πώς λειτουργεί η βάση δεδομένων του kad2025.gr · Τελευταία επαλήθευση: 12 Σεπτεμβρίου 2026
      </p>
          ...
          {[
            {
              ...
              desc: "Ορίζει το πλήρες σύστημα ΚΑΔ 2025 βάσει του ευρωπαϊκού προτύπου NACE Rev.2.1. Περιέχει 10.925 εγγραφές αντιστοίχισης (9.424 μοναδικούς ΚΑΔ 2025) οικονομικής δραστηριότητας. Ισχύς από 1η Μαρτίου 2026.",
            },
            {
            ...
            {
              title: "Απόφαση ΑΑΔΕ Α.1117/2026",
              desc: "Τροποποίηση της Α.1003/2026 (ΦΕΚ Β΄ 3046/29-05-2026, διόρθωση σφάλματος ΦΕΚ Β΄ 3059/02-06-2026) — προσθήκη ΚΑΔ 46.41.04.18 και 46.41.04.19 (χονδρικό εμπόριο υλικών γουνοποιίας) και 00.04 (έλλειψη δραστηριότητας λόγω εκκαθάρισης), και διόρθωση της περιγραφής του ΚΑΔ 70.20.12.15 σε «Υπηρεσίες φορολογικού αντιπροσώπου». Ισχύς από τη δημοσίευση. Εφαρμόστηκε στη βάση: 15/09/2026.",
            },
            {
              title: "Απόφαση ΑΑΔΕ Α.1118/2026",
              desc: "Τροποποίηση της Α.1004/2026 — παράταση της προθεσμίας επικαιροποίησης έως 30/10/2026, υπό την προϋπόθεση ότι δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ μετά την 1/3/2026.",
            },
            {
      ...
      <section className="card" style={{ marginBottom: "1.5rem" }}>
        ...
        <ol style={{ paddingLeft: "1.25rem", lineHeight: 2 }}>
          ...
          <li>Κανονικοποίηση κωδικών — οι κωδικοί διατηρούνται στην επίσημη μορφή των αρχείων ΑΑΔΕ (ορισμένοι εμφανίζονται χωρίς αρχικό μηδενικό, π.χ. 1150001 αντί 01150001)· κάθε εσωτερική σύγκριση και ομαδοποίηση γίνεται σε 8ψήφια μορφή με συμπλήρωση αρχικών μηδενικών</li>
      ...
      <section className="card" style={{ marginBottom: "1.5rem" }}>
        ...
        <div style={{ background: "var(--warn-bg)", border: "1px solid var(--warn-border)", borderRadius: 8, padding: "0.75rem 1rem", marginTop: "1rem", fontSize: "0.875rem", color: "var(--warn-text)" }}>
