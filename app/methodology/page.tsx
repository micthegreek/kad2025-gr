          ...
          {[
            {
              ...
              desc: "Ορίζει το πλήρες σύστημα ΚΑΔ 2025 βάσει του ευρωπαϊκού προτύπου NACE Rev.2.1. Περιέχει 10.923 εγγραφές αντιστοίχισης (9.422 μοναδικούς ΚΑΔ 2025) οικονομικής δραστηριότητας. Ισχύς από 1η Μαρτίου 2026.",
            },
            {
            ...
            },
            {
              ...
              desc: "Τροποποίηση της Α.1003/2026 — προσθήκη κωδικών και διόρθωση περιγραφής υφιστάμενου ΚΑΔ.",
            },
            {
