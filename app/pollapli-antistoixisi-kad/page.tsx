    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: { "@type": "Answer", text: "Ελέγξτε ποιος νέος ΚΑΔ 2025 περιγράφει καλύτερα τη συγκεκριμένη δραστηριότητά σας. Αν χρειάζεται διόρθωση, κάντε τη μέσω myAADE έως 30 Οκτωβρίου 2026 χωρίς πρόστιμο." },
        },
      ],
    },
  ],
  ...
  return (
    <div style={{ maxWidth: 860, margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      <section className="card" style={{ marginBottom: "1.5rem" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0.875rem" }}>
          {[
            ...
            { num: "5", title: "Διορθώστε μέσω myAADE έως 30/10/2026", desc: "Αν ο αυτόματα αποδοθείς ΚΑΔ δεν είναι ο σωστός, κάντε Μεταβολή Εργασιών στο myAADE. Η διόρθωση είναι χωρίς πρόστιμο έως 30 Οκτωβρίου 2026." },
          ].map((step) => (
      ...
      <section className="card" style={{ marginBottom: "1.5rem" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0.875rem" }}>
          {[
            { q: "Αν η ΑΑΔΕ επέλεξε αυτόματα έναν ΚΑΔ, μπορώ να τον αλλάξω;", a: "Ναι. Μέχρι 30 Οκτωβρίου 2026 μπορείτε να διορθώσετε τον ΚΑΔ σας χωρίς πρόστιμο μέσω της Μεταβολής Εργασιών στο myAADE." },
            ...
            { q: "Πόσο χρόνο έχω για να ελέγξω;", a: "Η προθεσμία για διόρθωση χωρίς πρόστιμο είναι 30 Οκτωβρίου 2026. Μετά από αυτή, ισχύουν οι τακτικές κυρώσεις για εκπρόθεσμη μεταβολή." },
