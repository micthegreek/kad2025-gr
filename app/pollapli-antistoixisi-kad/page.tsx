    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: { "@type": "Answer", text: "Ελέγξτε ποιος νέος ΚΑΔ 2025 περιγράφει καλύτερα τη συγκεκριμένη δραστηριότητά σας. Αν χρειάζεται διόρθωση, κάντε τη μέσω myAADE έως 30 Οκτωβρίου 2026 χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026)." },
        },
      ],
    },
  ],
  ...
  return (
    <div style={{ maxWidth: 860, margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      <div style={{ display: "flex", gap: "0.5rem", alignItems: "center", marginBottom: "1.5rem", flexWrap: "wrap" }}>
        <span style={{ fontSize: "0.75rem", fontWeight: 700, padding: "0.15rem 0.5rem", borderRadius: 20, background: "var(--danger)", color: "white" }}>Σημαντικό</span>
      ...
      <p style={{ fontSize: "1rem", lineHeight: 1.8, color: "var(--text-muted)", marginBottom: "2rem", borderLeft: "3px solid var(--danger)", paddingLeft: "1rem" }}>
      ...
      <section className="card" style={{ marginBottom: "1.5rem", borderLeft: "4px solid var(--danger)" }}>
      ...
      <section className="card" style={{ marginBottom: "1.5rem" }}>
        ...
        <p style={{ lineHeight: 1.8, marginBottom: "1rem" }}>
          Από τα 10.925 αρχεία αντιστοίχισης του πίνακα ΑΑΔΕ, σημαντικός αριθμός περιλαμβάνει
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "0.75rem" }}>
          {[
            ...
            <div key={s.sector} style={{ padding: "0.75rem", background: "var(--bg)", border: "1px solid var(--border)", borderRadius: 8 }}>
              ...
              <div style={{ fontSize: "0.78rem", color: s.risk === "Υψηλός" ? "var(--danger)" : s.risk === "Μέτριος" ? "var(--acc-amber)" : "var(--success)", fontWeight: 600, marginBottom: "0.2rem" }}>Κίνδυνος: {s.risk}</div>
      ...
      <section className="card" style={{ marginBottom: "1.5rem" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0.875rem" }}>
          {[
            ...
            { num: "5", title: "Διορθώστε μέσω myAADE έως 30/10/2026", desc: "Αν ο αυτόματα αποδοθείς ΚΑΔ δεν είναι ο σωστός, κάντε Μεταβολή Εργασιών στο myAADE. Η διόρθωση είναι χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026) έως 30 Οκτωβρίου 2026." },
          ].map((step) => (
      ...
      <section className="card" style={{ marginBottom: "1.5rem" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0.875rem" }}>
          {[
            { q: "Αν η ΑΑΔΕ επέλεξε αυτόματα έναν ΚΑΔ, μπορώ να τον αλλάξω;", a: "Ναι. Μέχρι 30 Οκτωβρίου 2026 μπορείτε να διορθώσετε τον ΚΑΔ σας χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026) μέσω της Μεταβολής Εργασιών στο myAADE." },
            ...
            { q: "Πόσο χρόνο έχω για να ελέγξω;", a: "Η προθεσμία για διόρθωση χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026) είναι 30 Οκτωβρίου 2026. Μετά από αυτή, ισχύουν οι τακτικές κυρώσεις για εκπρόθεσμη μεταβολή." },
