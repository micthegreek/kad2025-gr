...
const CATEGORIES: Category[] = [
  {
    ...
    color: "var(--danger)",
    items: [
      { label: "Εστιατόριο", kad: "56110000", desc: "Υπηρεσίες εστιατορίου" },
      { label: "Καφετέρια / Καφέ", kad: "56301000", desc: "Υπηρεσίες καφετέριας" },
      { label: "Ταβέρνα / Ψητοπωλείο", kad: "56110000", desc: "Υπηρεσίες εστιατορίων και κινητών μονάδων εστίασης" },
  ...
  },
  {
    ...
    color: "var(--acc-amber)",
    items: [
      { label: "Εργολάβος κτιρίων", kad: "41000000", desc: "Κατασκευή κατοικιών και άλλων κτιρίων" },
  ...
  },
  {
    ...
    items: [
      { label: "Ανάπτυξη λογισμικού", kad: "62100000", desc: "Δραστηριότητες προγραμματισμού" },
      { label: "Σχεδιασμός ιστοσελίδων", kad: "62100000", desc: "Ανάπτυξη εφαρμογών λογισμικού" },
  ...
  },
  {
    ...
    color: "var(--success)",
    items: [
      { label: "Γενικός ιατρός", kad: "86210000", desc: "Υπηρεσίες γενικής ιατρικής" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Δικηγόρος", kad: "69100000", desc: "Νομικές υπηρεσίες (δικηγόρου)" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Ξενοδοχείο", kad: "55100000", desc: "Υπηρεσίες παροχής καταλύματος" },
