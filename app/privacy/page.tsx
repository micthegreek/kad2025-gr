  ...
  return (
    <div style={{ maxWidth: 860, margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      <div style={{
        ...
        <h2 style={{ fontSize: "1rem", color: "var(--info-strong)", marginBottom: "0.75rem" }}>
          📋 Σύνοψη (απλά λόγια)
        </h2>
      ...
      <div style={{ lineHeight: 1.8 }}>
        ...
        <section id="adsense" className="card" style={{ marginBottom: "1.5rem", borderLeft: "4px solid var(--warn-border)" }}>
          ...
          <div style={{
            ...
            <p style={{ fontWeight: 700, marginBottom: "0.5rem", color: "var(--warn-strong)" }}>
              ⚠️ Cookies τρίτων μερών (Third-party cookies)
            </p>
            <p style={{ fontSize: "0.875rem", color: "var(--warn-text)", lineHeight: 1.7 }}>
              ...
              <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" style={{ color: "var(--warn-strong)", fontWeight: 600 }}>
