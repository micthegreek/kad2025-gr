...
export const metadata: Metadata = {
  ...
  description:
    "Αντιστοίχιση ΚΑΔ 2008→2025. Βρείτε ποιος νέος ΚΑΔ αντικαθιστά τον παλιό σας. 10.923 εγγραφές αντιστοίχισης, εξαγωγή Excel & CSV.",
  ...
  openGraph: {
    title: "Αντιστοίχιση ΚΑΔ 2008 με 2025 | Νέος ΚΑΔ Άμεσα",
    description: "Αντιστοίχιση ΚΑΔ 2008→2025 (νέοι ΚΑΔ 2026 ΑΑΔΕ). Instant αναζήτηση 10.923 εγγραφών αντιστοίχισης. Εξαγωγή Excel & CSV.",
  },
};
    ...
    "@graph": [
      ...
      },
      {
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "Τι γίνεται αν δεν συμφωνώ με την αυτόματη αντιστοίχιση της ΑΑΔΕ;", acceptedAnswer: { "@type": "Answer", text: "Μπορείτε να διορθώσετε τον ΚΑΔ σας μέσω της εφαρμογής Μεταβολή Εργασιών στο myaade.gov.gr έως 30 Οκτωβρίου 2026 χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026)." } },
        ],
      },
    ],
  };
    ...
    <div style={{ maxWidth: 1100, margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      <section className="card" style={{ marginBottom: "1.5rem" }}>
        ...
        <p style={{ lineHeight: 1.8 }}>
          Έχετε έως <strong>30 Οκτωβρίου 2026</strong> να διορθώσετε τυχόν λανθασμένη αντιστοίχιση χωρίς
      ...
      <section className="card" style={{ marginBottom: "1.5rem" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: "0.75rem" }}>
          {[
            ...
            { icon: "✅", title: "Αμετάβλητοι ΚΑΔ", desc: "Αν ο κωδικός παρέμεινε ίδιος, δεν προκύπτει αλλαγή αντιστοίχισης για τον συγκεκριμένο κωδικό — ελέγξτε ωστόσο τη συνολική εικόνα Μητρώου και τους υπόλοιπους ΚΑΔ σας στο myAADE — η ΑΑΔΕ το επιβεβαιώνει." },
      ...
      <section className="card" style={{ marginBottom: "1.5rem" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
          {[
            ...
            { q: "Μέχρι πότε μπορώ να διορθώσω τον ΚΑΔ χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026);", a: "Έως 30 Οκτωβρίου 2026, μέσω της εφαρμογής Μεταβολή Εργασιών στο myaade.gov.gr." },
