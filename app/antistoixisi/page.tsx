...
export const metadata: Metadata = {
  ...
  description:
    "Αντιστοίχιση ΚΑΔ 2008→2025. Βρείτε ποιος νέος ΚΑΔ αντικαθιστά τον παλιό σας. 10.925 εγγραφές αντιστοίχισης, εξαγωγή Excel & CSV.",
  ...
  openGraph: {
    ...
    description: "Αντιστοίχιση ΚΑΔ 2008→2025 (νέοι ΚΑΔ 2026 ΑΑΔΕ). Instant αναζήτηση 10.925 εγγραφών αντιστοίχισης. Εξαγωγή Excel & CSV.",
  },
};
