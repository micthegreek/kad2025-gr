    ...
    "@graph": [
      ...
      },
      {
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "Τι γίνεται αν δεν συμφωνώ με την αυτόματη αντιστοίχιση της ΑΑΔΕ;", acceptedAnswer: { "@type": "Answer", text: "Μπορείτε να διορθώσετε τον ΚΑΔ σας μέσω της εφαρμογής Μεταβολή Εργασιών στο myaade.gov.gr έως 30 Οκτωβρίου 2026 χωρίς πρόστιμο." } },
        ],
      },
    ],
  };
      ...
      <section className="card" style={{ marginBottom: "1.5rem" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
          {[
            ...
            { q: "Μέχρι πότε μπορώ να διορθώσω τον ΚΑΔ χωρίς πρόστιμο;", a: "Έως 30 Οκτωβρίου 2026, μέσω της εφαρμογής Μεταβολή Εργασιών στο myaade.gov.gr." },
