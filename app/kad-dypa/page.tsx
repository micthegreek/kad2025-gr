...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "Έχετε έως 30/10/2026 να διορθώσετε τον ΚΑΔ σας στο myAADE χωρίς πρόστιμο. Αν η αυτόματη αντιστοίχιση ΑΑΔΕ οδήγησε σε λάθος ΚΑΔ, μπορείτε να το διορθώσετε.",
  },
  {
