...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "Έχετε έως 30/10/2026 να διορθώσετε τον ΚΑΔ σας στο myAADE χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026). Αν η αυτόματη αντιστοίχιση ΑΑΔΕ οδήγησε σε λάθος ΚΑΔ, μπορείτε να το διορθώσετε.",
  },
  {
      ...
      <div style={{ maxWidth: 860, margin: "0 auto", padding: "2rem 1rem" }}>
        ...
        <div className="card" style={{ marginBottom: "1.5rem", borderLeft: "4px solid #0369a1" }}>
          ...
          <div style={{ marginTop: "1rem", padding: "0.75rem", background: "var(--bg)", borderRadius: 8, border: "1px solid var(--border)" }}>
            ...
            σε λάθος κωδικό, διορθώστε τον <strong>έως 30/10/2026</strong>.
          </div>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "0.75rem" }}>
          {[
            ...
            { href: "/prothesmia-kad-2025", label: "Προθεσμία 30/10/2026" },
