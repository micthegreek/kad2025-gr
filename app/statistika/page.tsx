    ...
    <div style={{ maxWidth: 1000, margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(170px, 1fr))", gap: "1rem", marginBottom: "1.5rem" }}>
        {[
          ...
          { label: "Μοναδικοί ΚΑΔ 2008", value: unique2008.toLocaleString("el-GR"), icon: "📂", color: "var(--info-strong)" },
          { label: "Μοναδικοί ΚΑΔ 2025", value: unique2025.toLocaleString("el-GR"), icon: "🆕", color: "var(--success-strong)" },
          { label: "Άλλαξαν ΚΑΔ", value: changed.toLocaleString("el-GR"), icon: "🔄", color: "var(--warn-strong)" },
