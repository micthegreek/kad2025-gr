...
export const metadata: Metadata = {
  ...
  description:
    "Αν η ΑΑΔΕ αντιστοίχησε λάθος τον ΚΑΔ σας, έχετε έως 30/10/2026 να το διορθώσετε χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026). Δείτε πώς μέσω myAADE βήμα-βήμα.",
  robots: { index: true, follow: true },
  alternates: { canonical: "https://www.kad2025.gr/lathos-antistoixisi" },
  openGraph: {
    title: "Λάθος Αντιστοίχιση ΚΑΔ 2025; Πώς να το Διορθώσετε",
    description: "Οδηγός διόρθωσης λανθασμένης αντιστοίχισης ΚΑΔ 2025 μέσω myAADE. Χωρίς πρόστιμο έως 30/10/2026.",
  },
};
      ...
      mainEntity: [
        {
          ...
          acceptedAnswer: { "@type": "Answer", text: "Πηγαίνετε στο myAADE → Μεταβολή Εργασιών → επιλέξτε τον σωστό ΚΑΔ 2025. Έχετε έως 30/10/2026 χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026)." },
        },
        {
          "@type": "Question",
          name: "Μέχρι πότε μπορώ να διορθώσω τον ΚΑΔ χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026);",
          acceptedAnswer: { "@type": "Answer", text: "Έως 30 Οκτωβρίου 2026 μπορείτε να διορθώσετε χωρίς κυρώσεις." },
        },
      ],
    },
  ],
  ...
  return (
    <div style={{ maxWidth: 900, margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      <div style={{ background: "var(--warn-bg)", border: "1px solid var(--warn-border)", borderRadius: 8, padding: "0.75rem 1rem", marginBottom: "1.5rem", fontSize: "0.875rem", fontWeight: 600 }}>
        ⏰ Προθεσμία διόρθωσης χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026): <strong>30 Οκτωβρίου 2026</strong>
      </div>
      ...
      <p style={{ color: "var(--text-muted)", fontSize: "0.95rem", lineHeight: 1.7, marginBottom: "2rem" }}>
        ...
        τον νέο ΚΑΔ 2025 που σας ανατέθηκε, έχετε δικαίωμα διόρθωσης έως <strong>30 Οκτωβρίου 2026</strong> χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026).
      </p>
