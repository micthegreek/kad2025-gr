...
const POPULAR: Array<{ term: string; kad: string; desc: string; searchMode?: boolean }> = [
  { term: "εστιατόριο", kad: "56110000", desc: "Υπηρεσίες εστιατορίου" },
  ...
  { term: "κατασκευές", kad: "41000000", desc: "Κατασκευή κτιρίων" },
  ...
  { term: "IT / software", kad: "62100000", desc: "Ανάπτυξη λογισμικού" },
  { term: "ακίνητα", kad: "68311000", desc: "Υπηρεσίες μεσιτικού γραφείου" },
  { term: "ιατρός", kad: "86210000", desc: "Υπηρεσίες γενικής ιατρικής" },
