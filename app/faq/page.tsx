...
export const metadata: Metadata = {
  ...
  description:
    "Απαντήσεις ΑΑΔΕ: υπόχρεοι αντιστοίχισης ΚΑΔ 2025, μετάβαση στους νέους κωδικούς, προθεσμία 30/10/2026, διόρθωση μέσω myAADE.",
...
const faqs = [
  ...
  { q: "Σε περίπτωση που δεν διενεργήθηκε η αυτόματη αντιστοίχιση, πώς υποβάλλεται η δήλωση νέων ΚΑΔ 2025;", a: "Κατόπιν ειδοποίησης του φορολογούμενου, υποβάλλεται αίτημα έως την 30 Οκτωβρίου 2026 χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026), μέσω της εφαρμογής «Τα Αιτήματά μου» στο myAADE (myaade.gov.gr), στη θεματική ενότητα Μητρώο.\n\n• Φυσικά πρόσωπα: Μεταβολή εργασιών φυσικού προσώπου που δεν δύναται να ολοκληρωθεί μέσω της Ψηφιακής Πύλης myAADE.\n• Νομικά πρόσωπα/οντότητες: Μεταβολή εργασιών ημεδαπών/αλλοδαπών νομικών προσώπων και νομικών οντοτήτων που δεν δύναται να ολοκληρωθεί μέσω της Ψηφιακής Πύλης myAADE.\n\nΚατά την υποβολή επισυνάπτεται η δήλωση Μητρώου (έντυπο Δ211) και τα κατά περίπτωση δικαιολογητικά." },
    ...
    <>
      ...
      <div style={{ maxWidth: 1000, margin: "0 auto", padding: "2rem 1rem" }}>
        ...
        <div style={{ background: "rgba(234,179,8,0.15)", border: "1px solid rgba(234,179,8,0.4)", borderRadius: "var(--radius, 12px)", padding: "0.75rem 1rem", marginBottom: "2rem", display: "flex", alignItems: "center", gap: "0.5rem", fontSize: "0.9rem" }}>
          <span>⚠️</span>
          <span><strong>Προθεσμία:</strong> Διορθώσεις χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026) έως <strong>30 Οκτωβρίου 2026</strong></span>
        </div>
