    ...
    <div style={{ maxWidth: 860, margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      <section className="card" style={{ marginBottom: "1.5rem", borderLeft: "4px solid var(--primary)" }}>
        ...
        <p style={{ lineHeight: 1.8, marginBottom: "1rem" }}>
          ...
          πλήρη αντιστοίχιση των <strong>10.925 εγγραφών αντιστοίχισης</strong> με εργαλεία αναζήτησης, μαζική
          ...
          {[
            {
              ...
              detail: "Ορίζει το πλήρες σύστημα ΚΑΔ 2025 με 10.925 εγγραφές αντιστοίχισης σε εναρμόνιση με το ευρωπαϊκό πρότυπο NACE Rev.2.1.",
            },
            {
              code: "Α.1004/2026",
