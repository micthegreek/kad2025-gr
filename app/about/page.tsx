    ...
    <div style={{ maxWidth: 860, margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      <section className="card" style={{ marginBottom: "1.5rem", borderLeft: "4px solid var(--primary)" }}>
        ...
        <p style={{ lineHeight: 1.8, marginBottom: "1rem" }}>
          ...
          πλήρη αντιστοίχιση των <strong>10.923 εγγραφών αντιστοίχισης</strong> με εργαλεία αναζήτησης, μαζική
          ...
          {[
            {
              ...
              detail: "Ορίζει το πλήρες σύστημα ΚΑΔ 2025 με 10.923 εγγραφές αντιστοίχισης σε εναρμόνιση με το ευρωπαϊκό πρότυπο NACE Rev.2.1.",
            },
            {
              code: "Α.1004/2026",
      ...
      <section className="card" style={{ marginBottom: "1.5rem", background: "var(--info-bg)", border: "1px solid var(--info-border)" }}>
        ...
        <p style={{ lineHeight: 1.8, marginBottom: "0.75rem", color: "var(--info-text)" }}>
        ...
        <p style={{ lineHeight: 1.8, color: "var(--info-text)" }}>
      ...
      >
        <h2 style={{ fontSize: "1rem", marginBottom: "0.5rem", color: "var(--warn-strong)" }}>
        ...
        <p style={{ fontSize: "0.875rem", lineHeight: 1.7, color: "var(--warn-text)", margin: 0 }}>
          ...
          απευθείας το{" "}
          <a href="https://myaade.gov.gr" target="_blank" rel="noopener noreferrer" style={{ color: "var(--warn-strong)", fontWeight: 700 }}>
            myaade.gov.gr
          </a>.
        </p>
      </section>
