...
export const metadata: Metadata = {
  ...
  description:
    "Πώς να αλλάξετε ΚΑΔ στο myAADE βήμα-βήμα. Μεταβολή Εργασιών, έντυπο Δ211, προθεσμίες και συχνά λάθη. Έως 30/10/2026 χωρίς πρόστιμο.",
...
const FAQS = [
  { q: "Μέχρι πότε μπορώ να αλλάξω ΚΑΔ χωρίς πρόστιμο;", a: "Έως 30 Οκτωβρίου 2026 μπορείτε να διορθώσετε τον ΚΑΔ σας χωρίς κυρώσεις, εφόσον η αυτόματη αντιστοίχιση της ΑΑΔΕ δεν ήταν σωστή." },
  ...
  return (
    <div style={{ maxWidth: 900, margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      <div style={{ background: "var(--warn-bg)", border: "1px solid var(--warn-border)", borderRadius: 8, padding: "0.75rem 1rem", marginBottom: "1.5rem", fontSize: "0.875rem", fontWeight: 600 }}>
        ⏰ Προθεσμία χωρίς πρόστιμο: <strong>30 Οκτωβρίου 2026</strong>
      </div>
