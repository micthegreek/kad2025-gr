...
export const metadata: Metadata = {
  ...
  description:
    "Πώς να αλλάξετε ΚΑΔ στο myAADE βήμα-βήμα. Μεταβολή Εργασιών, έντυπο Δ211, προθεσμίες και συχνά λάθη. Έως 30/10/2026 χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026).",
...
const FAQS = [
  { q: "Μέχρι πότε μπορώ να αλλάξω ΚΑΔ χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026);", a: "Έως 30 Οκτωβρίου 2026 μπορείτε να διορθώσετε τον ΚΑΔ σας χωρίς κυρώσεις, εφόσον η αυτόματη αντιστοίχιση της ΑΑΔΕ δεν ήταν σωστή." },
  ...
  { q: "Τι γίνεται αν δεν αλλάξω ΚΑΔ εγκαίρως;", a: "Μετά την 30/10/2026 μπορεί να επιβληθούν κυρώσεις. Ωστόσο, αν η αυτόματη αντιστοίχιση της ΑΑΔΕ είναι σωστή, δεν χρειάζεται να κάνετε τίποτα." },
];
  ...
  return (
    <div style={{ maxWidth: 900, margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      <div style={{ background: "var(--warn-bg)", border: "1px solid var(--warn-border)", borderRadius: 8, padding: "0.75rem 1rem", marginBottom: "1.5rem", fontSize: "0.875rem", fontWeight: 600 }}>
        ⏰ Προθεσμία χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026): <strong>30 Οκτωβρίου 2026</strong>
      </div>
      ...
      <p style={{ color: "var(--text-muted)", fontSize: "0.95rem", lineHeight: 1.7, marginBottom: "2rem" }}>
        ...
        Έχετε έως <strong>30/10/2026</strong> να διορθώσετε χωρίς κυρώσεις.
      </p>
