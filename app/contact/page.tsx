  ...
  return (
    <div style={{ maxWidth: 760, margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      <div className="card" style={{ marginBottom: "1.5rem", background: "var(--warn-bg)", border: "1px solid var(--warn-border)" }}>
        <h2 style={{ fontSize: "1rem", marginBottom: "0.5rem", color: "var(--warn-strong)" }}>⚠️ Σημαντική Σημείωση</h2>
        ...
        <p style={{ fontSize: "0.875rem", color: "var(--warn-text)", lineHeight: 1.7, marginTop: "0.5rem" }}>
