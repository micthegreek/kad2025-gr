    ...
    <div style={{ maxWidth: 860, margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      <section className="card" style={{ marginBottom: "1.5rem", borderLeft: "4px solid var(--primary)" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
          {[
            {
              ref: "Α.1003/12-01-2026 (ΦΕΚ Β΄ 235)",
              title: "Κατάλογος ΚΑΔ 2025 — Παράρτημα Ι",
              body: "Απόφαση Διοικητή ΑΑΔΕ που καθορίζει τη νέα Εθνική Ονοματολογία Οικονομικών Δραστηριοτήτων βάσει NACE Rev.2.1. Ορίζει τον ΚΑΤΑΛΟΓΟ των ενεργών κωδικών (9.424 μοναδικοί ΚΑΔ 2025). Ισχύς από 1η Μαρτίου 2026. Όπως τροποποιήθηκε με την Α.1117/2026.",
              source: "aade.gr",
              href: "https://www.aade.gr/egkyklioi-kai-apofaseis/1003-12-01-2026",
            },
            {
              ref: "Α.1117/28-05-2026 (ΦΕΚ Β΄ 3046)",
              title: "Τροποποίηση του καταλόγου ΚΑΔ 2025",
              body: "Προσθήκη των ΚΑΔ 46.41.04.18 και 46.41.04.19 (χονδρικό εμπόριο υλικών γουνοποιίας) και 00.04 (έλλειψη δραστηριότητας λόγω εκκαθάρισης). Διόρθωση της περιγραφής του ΚΑΔ 70.20.12.15 σε «Υπηρεσίες φορολογικού αντιπροσώπου». Διόρθωση σφάλματος: ΦΕΚ Β΄ 3059/02-06-2026. Εφαρμόστηκε στη βάση: 15/09/2026.",
              source: "aade.gr",
              href: "https://www.aade.gr/egkyklioi-kai-apofaseis/1117-28-05-2026",
            },
            {
              ref: "Α.1004/12-01-2026",
              title: "Πίνακας αντιστοίχισης ΚΑΔ 2008 → ΚΑΔ 2025",
              body: "Διαφορετικό έγγραφο από την Α.1003: ορίζει τη ΔΙΑΔΙΚΑΣΙΑ και τον ΠΙΝΑΚΑ ΜΕΤΑΒΑΣΗΣ (10.925 εγγραφές αντιστοίχισης), βάσει του οποίου έγινε η αυτόματη αντιστοίχιση στις 9 Μαρτίου 2026. Όπως τροποποιήθηκε με την Α.1118/2026 ως προς την προθεσμία διορθώσεων.",
              source: "aade.gr",
              href: "https://www.aade.gr/egkyklioi-kai-apofaseis/1004-12-01-2026",
            },
            {
              ref: "Α.1118/28-05-2026",
              title: "Παράταση προθεσμίας επικαιροποίησης",
              body: "Τροποποίηση της Α.1004/2026. Μεταθέτει την προθεσμία διορθώσεων χωρίς πρόστιμο στις 30 Οκτωβρίου 2026, υπό την προϋπόθεση ότι δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026. Μετά την προθεσμία επιβάλλονται οι κυρώσεις του άρθρου 53 ΚΦΔ.",
              source: "aade.gr",
              href: "https://www.aade.gr/egkyklioi-kai-apofaseis/1118-28-05-2026",
            },
            {
              ref: "myaade.gov.gr",
          ...
          {[
            ...
            <div key={s.ref} style={{ padding: "0.75rem 1rem", background: "var(--bg)", border: "1px solid var(--border)", borderLeft: "3px solid #3b82f6", borderRadius: 8 }}>
              <div style={{ display: "flex", gap: "0.5rem", alignItems: "center", marginBottom: "0.25rem", flexWrap: "wrap" }}>
                <span style={{ fontWeight: 700, color: "var(--info-strong)", fontSize: "0.88rem" }}>{s.ref}</span>
      ...
      <div style={{ background: "var(--warn-bg)", border: "1px solid var(--warn-border)", borderRadius: "var(--radius)", padding: "1rem", marginBottom: "1.5rem" }}>
        <p style={{ fontSize: "0.875rem", color: "var(--warn-text)", lineHeight: 1.7, margin: 0 }}>
