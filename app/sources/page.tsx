          ...
          {[
            {
              ...
              body: "Απόφαση Διοικητή ΑΑΔΕ που ορίζει το νέο σύστημα ΚΑΔ 2025 βάσει NACE Rev.2.1. Δημοσιεύτηκε στη ΦΕΚ και ισχύει από 1η Μαρτίου 2026. Περιέχει τους 10.923 εγγραφές αντιστοίχισης (9.422 μοναδικοί ΚΑΔ 2025) με πλήρεις περιγραφές.",
              source: "aade.gr",
            },
            {
              ref: "Α.1004/2026",
