...
export default function AnoixtaProgrammataPage() {
  return (
    <div style={{ maxWidth: 860, margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      <div style={{ background: "var(--warn-bg)", border: "1px solid var(--warn-border)", borderRadius: "var(--radius)", padding: "1rem", marginBottom: "2rem" }}>
        <strong style={{ color: "var(--warn-strong)" }}>⚠️ Ενημερωτική σημείωση:</strong>
      ...
      <section className="card" style={{ marginBottom: "1.5rem", background: "var(--info-bg)", border: "1px solid var(--info-border)" }}>
        <h2 style={{ fontSize: "1.1rem", marginBottom: "0.75rem", color: "var(--info-strong)" }}>
          🔍 Ελέγξτε αμέσως αν ο ΚΑΔ σας είναι επιλέξιμος
        </h2>
        <p style={{ lineHeight: 1.8, fontSize: "0.9rem", color: "var(--info-text)", marginBottom: "1rem" }}>
      ...
      <section className="card" style={{ marginBottom: "1.5rem" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
          {[
            ...
            "Αν ο ΚΑΔ είναι λανθασμένος, διορθώστε τον μέσω myAADE έως 30/10/2026 χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026)",
      ...
      <div style={{ display: "flex", gap: "0.75rem", flexWrap: "wrap" }}>
        <Link href="/kad-epidotisi-espa" className="btn btn-ghost">💰 Έλεγχος Επιλεξιμότητας</Link>
