  ...
  return (
    <div style={{ maxWidth: 860, margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      <div style={{ background: "var(--warn-bg)", border: "1px solid var(--warn-border)", borderRadius: "var(--radius)", padding: "1rem", marginBottom: "1.5rem" }}>
        <strong style={{ color: "var(--warn-strong)" }}>⚠️ Σημαντική σημείωση:</strong>
        <p style={{ fontSize: "0.875rem", color: "var(--warn-text)", lineHeight: 1.7, margin: "0.5rem 0 0" }}>
      ...
      <section className="card" style={{ marginBottom: "1.5rem" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
          {[
            { prog: "ΕΣΠΑ (Ευρωπαϊκά Διαρθρωτικά Ταμεία) 2021–2027", impact: "Υψηλή", desc: "Τα περισσότερα νέα προγράμματα ΕΣΠΑ 2021–2027 που εκδίδονται από το 2026 και μετά χρησιμοποιούν αποκλειστικά ΚΑΔ 2025. Ο πίνακας επιλέξιμων ΚΑΔ κάθε πρόσκλησης αντιστοιχεί στο νέο σύστημα.", color: "var(--danger)" },
            { prog: "ΔΥΠΑ (Επιδοτήσεις Απασχόλησης)", impact: "Μέτρια", desc: "Η ΔΥΠΑ ενημερώνει σταδιακά τους επιλέξιμους ΚΑΔ στα προγράμματα απασχόλησης. Ορισμένα παλαιότερα προγράμματα εξακολουθούν να αναφέρουν ΚΑΔ 2008. Ελέγξτε πάντα τον επίσημο οδηγό κάθε προγράμματος.", color: "var(--acc-amber)" },
            { prog: "Αναπτυξιακός Νόμος (Ν. 4887/2022)", impact: "Υψηλή", desc: "Ο Αναπτυξιακός Νόμος χρησιμοποιεί ΚΑΔ για τον ορισμό επιλέξιμων δραστηριοτήτων, ποσοστών ενίσχυσης και κατηγοριοποίησης καθεστώτων. Τα νέα καθεστώτα ενίσχυσης (Μεταποίηση, Περιοχές, Μεγάλες Επενδύσεις) εκδίδουν πίνακες σε ΚΑΔ 2025.", color: "var(--danger)" },
            { prog: "Ταμείο Ανάκαμψης (RRF)", impact: "Χαμηλή", desc: "Τα περισσότερα έργα RRF έχουν ήδη εγκριθεί με βάση τον παλαιότερο πίνακα ΚΑΔ. Νέες δράσεις ή τροποποιήσεις θα χρησιμοποιούν ΚΑΔ 2025.", color: "var(--success)" },
          ].map((p) => (
      ...
      <section className="card" style={{ marginBottom: "1.5rem" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
          {[
            ...
            "Αν υπάρχει ασυμφωνία, διορθώστε τον ΚΑΔ έως 30/10/2026 χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026) μέσω myAADE",
      ...
      <section className="card" style={{ marginBottom: "1.5rem", background: "var(--success-bg)", border: "1px solid var(--success-border)" }}>
        <h2 style={{ fontSize: "1.1rem", marginBottom: "0.75rem", color: "var(--success-strong)" }}>Πρακτικό παράδειγμα</h2>
        <p style={{ lineHeight: 1.8, fontSize: "0.9rem", color: "var(--success-text)", marginBottom: "0.75rem" }}>
        ...
        <p style={{ lineHeight: 1.8, fontSize: "0.9rem", color: "var(--success-text)" }}>
