  ...
  return (
    <div style={{ maxWidth: 860, margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      <section className="card" style={{ marginBottom: "1.5rem", borderLeft: "4px solid #7c3aed" }}>
        ...
        <div style={{ marginTop: "0.75rem" }}>
          <Link href="/ai-suggester" className="btn btn-ghost" style={{ fontSize: "0.85rem" }}>AI Βοηθός ΚΑΔ →</Link>
        </div>
      </section>
      ...
      <section className="card" style={{ marginBottom: "1.5rem", borderLeft: "4px solid var(--success)" }}>
        ...
        <div style={{ marginTop: "0.75rem" }}>
          <Link href="/wizard" className="btn btn-ghost" style={{ fontSize: "0.85rem" }}>Wizard — Βρες τον ΚΑΔ σου →</Link>
        </div>
      </section>
      ...
      <section className="card" style={{ marginBottom: "1.5rem" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "0.5rem" }}>
          {[
            ...
            { act: "Λιανικό e-shop (ανά κατηγορία προϊόντων)", kad: "47910000" },
