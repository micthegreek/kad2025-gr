...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Με απόφαση Α.1118/2026, η ΑΑΔΕ παρατείνει την προθεσμία επικαιροποίησης ΚΑΔ 2025 έως 30/10/2026 χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026).",
    ...
    <div style={{ maxWidth: 860, margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      <div style={{ background: "var(--success-bg)", border: "2px solid #22c55e", borderRadius: 12, padding: "1.25rem 1.5rem", marginBottom: "2rem" }}>
        ...
        <p style={{ margin: 0, fontSize: "0.95rem", lineHeight: 1.7, color: "var(--success-strong)" }}>
          ...
          <strong>30 Οκτωβρίου 2026</strong> — χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026).
        </p>
      </div>
      ...
      <section className="card" style={{ marginBottom: "1.5rem", background: "#fef9c3", border: "1.5px solid #fbbf24" }}>
        ...
        <p style={{ lineHeight: 1.8, color: "var(--warn-text)", marginBottom: "0.75rem", fontSize: "0.95rem" }}>
          Η δυνατότητα υποβολής δήλωσης μεταβολής χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026) ισχύει <strong>μόνο εφόσον δεν
        ...
        <p style={{ lineHeight: 1.8, color: "var(--warn-text)", margin: 0, fontSize: "0.9rem" }}>
          ...
          αντιστοίχισης), η παράταση δεν σας αφορά για δεύτερη μεταβολή χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026). Η
