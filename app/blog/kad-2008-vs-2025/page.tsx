...
const faqItems = [
  ...
  },
  {
    ...
    a: "Ελέγξτε στο myAADE (Μητρώο & Επικοινωνία → Βεβαιώσεις Μητρώου → Τρέχουσα Εικόνα Οντότητας) τον κωδικό που σας αποδόθηκε αυτόματα στις 9 Μαρτίου 2026. Αν δεν αποδίδει σωστά τη δραστηριότητά σας, διορθώνετε χωρίς πρόστιμο έως τις 30 Οκτωβρίου 2026 (Α.1118/2026) μέσω της εφαρμογής «Μεταβολή Εργασιών».",
  },
];
    ...
    <div className="post-layout">
      ...
      <section id="s6" className="card" style={{ marginBottom: "1.5rem" }}>
        ...
        <p style={{ lineHeight: 1.8, marginTop: "0.75rem", fontSize: "0.9rem", color: "var(--text-muted)" }}>
          ...
          χωρίς πρόστιμο έως τις <strong>30 Οκτωβρίου 2026</strong>, σύμφωνα με την Α.1118/2026.
        </p>
      </section>
