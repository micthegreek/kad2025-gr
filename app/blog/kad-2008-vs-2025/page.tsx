...
const faqItems = [
  {
    ...
    a: "Από τις 10.925 εγγραφές του επίσημου πίνακα αντιστοίχισης (Α.1004/2026), οι 7.240 (66,3%) προβλέπουν αλλαγή κωδικού και οι 3.683 (33,7%) διατηρούν τον ίδιο αριθμό. Επιπλέον, 906 κωδικοί κράτησαν τον αριθμό τους αλλά απέκτησαν επικαιροποιημένη περιγραφή.",
  },
  {
  ...
  },
  {
    ...
    a: "Ελέγξτε στο myAADE (Μητρώο & Επικοινωνία → Βεβαιώσεις Μητρώου → Τρέχουσα Εικόνα Οντότητας) τον κωδικό που σας αποδόθηκε αυτόματα στις 9 Μαρτίου 2026. Αν δεν αποδίδει σωστά τη δραστηριότητά σας, διορθώνετε χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026) έως τις 30 Οκτωβρίου 2026 (Α.1118/2026) μέσω της εφαρμογής «Μεταβολή Εργασιών».",
  },
];
    ...
    <div className="post-layout">
      ...
      <section id="s1" className="card" style={{ marginBottom: "1.5rem", borderLeft: "4px solid var(--primary)" }}>
        ...
        <p style={{ lineHeight: 1.8 }}>
          ...
          την Α.1118/2026 η προθεσμία διόρθωσης παρατάθηκε έως τις 30 Οκτωβρίου 2026.
        </p>
      </section>
      ...
      <section id="s2" className="card" style={{ marginBottom: "1.5rem" }}>
        ...
        <p style={{ lineHeight: 1.8, fontSize: "0.9rem", color: "var(--text-muted)" }}>
          ...
          κωδικοί καταλήγουν σε 9.424 νέους δείχνει και τη γενική κατεύθυνση της αναθεώρησης:
      ...
      <section id="s6" className="card" style={{ marginBottom: "1.5rem" }}>
        ...
        <p style={{ lineHeight: 1.8, marginTop: "0.75rem", fontSize: "0.9rem", color: "var(--text-muted)" }}>
          ...
          χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026) έως τις <strong>30 Οκτωβρίου 2026</strong>, σύμφωνα με την Α.1118/2026.
        </p>
      </section>
