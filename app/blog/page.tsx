...
const articles = [
  ...
  { href: "/blog/kladoi-pou-allaksan-kad-2025", title: "Οι Κλάδοι που Άλλαξαν 100% — και οι 3 που Δεν Άλλαξαν Καθόλου", desc: "Ανάλυση 10.923 εγγραφών αντιστοίχισης: λιανικό, πληροφορική και ένδυση άλλαξαν πλήρως· τρεις κλάδοι έμειναν άθικτοι. Δείτε τον δικό σας.", date: "5 Ιουλίου 2026", tag: "📊 Ανάλυση", readTime: "6 λεπτά" },
