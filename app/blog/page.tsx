...
export const metadata: Metadata = {
  title: "Οδηγοί ΚΑΔ 2025/2026: Προθεσμία, Διορθώσεις, Επιδοτήσεις",
  ...
  "@graph": [
    ...
    },
    {
      ...
      mainEntity: [
        ...
        { "@type": "Question", name: "Μέχρι πότε μπορώ να διορθώσω τον ΚΑΔ χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026);", acceptedAnswer: { "@type": "Answer", text: "Έως 30 Οκτωβρίου 2026 μέσω myAADE." } },
      ],
    },
  ],
};
...
const articles = [
  ...
  { href: "/blog/kladoi-pou-allaksan-kad-2025", title: "Οι Κλάδοι που Άλλαξαν 100% — και οι 3 που Δεν Άλλαξαν Καθόλου", desc: "Ανάλυση 10.925 εγγραφών αντιστοίχισης: λιανικό, πληροφορική και ένδυση άλλαξαν πλήρως· τρεις κλάδοι έμειναν άθικτοι. Δείτε τον δικό σας.", date: "5 Ιουλίου 2026", tag: "📊 Ανάλυση", readTime: "6 λεπτά" },
  ...
  { href: "/blog/paratasi-prothesmias-kad-30-oktovriou", title: "Παράταση Προθεσμίας ΚΑΔ: Νέα Ημερομηνία 30 Οκτωβρίου 2026", desc: "Με απόφαση ΑΑΔΕ Α.1118/2026, η προθεσμία επικαιροποίησης ΚΑΔ 2025 παρατείνεται από 1η Ιουνίου στις 30 Οκτωβρίου 2026 χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026).", date: "4 Ιουνίου 2026", tag: "", readTime: "5 λεπτά" },
...
const faqs = [
  ...
  { q: "Μέχρι πότε διορθώνω χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026);", a: "Έως 30 Οκτωβρίου 2026, μέσω Μεταβολή Εργασιών στο myAADE ή με έντυπο Δ211." },
    ...
    <div style={{ maxWidth: 900, margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      <section className="card" style={{ marginBottom: "1.5rem", borderLeft: "4px solid var(--primary)" }}>
        ...
        <p style={{ lineHeight: 1.8 }}>
          ...
          δεν είναι σωστή για τη δραστηριότητά σας, έχετε έως <strong>30 Οκτωβρίου 2026</strong> να διορθώσετε χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026).
        </p>
      </section>
