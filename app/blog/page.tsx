...
const articles = [
  { href: "/blog/lathos-kad-prostima", title: "Λάθος ΚΑΔ: Πρόστιμα & Συνέπειες το 2026", desc: "Το άμεσο πρόστιμο, οι έμμεσες συνέπειες σε ΕΣΠΑ και μητρώα, και το παράθυρο δωρεάν διόρθωσης έως 30/10/2026.", date: "10 Ιουνίου 2026", tag: "🔴 Νέο", readTime: "9 λεπτά" },
  { href: "/blog/kad-gia-eshop", title: "ΚΑΔ για E-shop: Οδηγός μετά την Κατάργηση του 47.91", desc: "Γιατί δεν υπάρχει πια ενιαίος ΚΑΔ e-shop, πώς ταξινομείται το ηλεκτρονικό εμπόριο ανά προϊόν, και τι ισχύει για marketplaces.", date: "10 Ιουνίου 2026", tag: "🔴 Νέο", readTime: "8 λεπτά" },
  { href: "/blog/kad-airbnb-vraxychronia", title: "ΚΑΔ για Airbnb: 55.20 ή 68.20 — και Πότε Κανέναν", desc: "Η κρίσιμη διάκριση καταλύματος/εκμίσθωσης, το όριο των 3 ακινήτων, ΑΜΑ vs ΚΑΔ, και τι άλλαξε στους ΚΑΔ 2025.", date: "10 Ιουνίου 2026", tag: "🔴 Νέο", readTime: "8 λεπτά" },

  { href: "/blog/paratasi-prothesmias-kad-30-oktovriou", title: "Παράταση Προθεσμίας ΚΑΔ: Νέα Ημερομηνία 30 Οκτωβρίου 2026", desc: "Με απόφαση ΑΑΔΕ Α.1113/2026, η προθεσμία επικαιροποίησης ΚΑΔ 2025 παρατείνεται από 1η Ιουνίου στις 30 Οκτωβρίου 2026 χωρίς πρόστιμο.", date: "4 Ιουνίου 2026", tag: "🔴 Νέο", readTime: "5 λεπτά" },
