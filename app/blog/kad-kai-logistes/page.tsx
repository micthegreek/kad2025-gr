  ...
  return (
    <div style={{ maxWidth: 860, margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      <p style={{ fontSize: "1rem", lineHeight: 1.8, color: "var(--text-muted)", marginBottom: "2rem", borderLeft: "3px solid var(--primary)", paddingLeft: "1rem" }}>
        ...
        προβλήματα και να ολοκληρώσετε τη διαδικασία πριν την προθεσμία της 30ής Οκτωβρίου 2026.
      </p>
      ...
      <section className="card" style={{ marginBottom: "1.5rem" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem", marginBottom: "1rem" }}>
          {[
            { label: "Χωρίς πρόβλημα", desc: "Ο νέος ΚΑΔ 2025 φαίνεται σωστός και αντικατοπτρίζει τη δραστηριότητα. Δεν απαιτείται ενέργεια.", color: "var(--success)" },
            { label: "Πιθανό πρόβλημα — να επιβεβαιωθεί", desc: "Υπάρχει ασυμφωνία ή αβεβαιότητα. Χρειάζεται επικοινωνία με τον πελάτη για επιβεβαίωση.", color: "var(--acc-amber)" },
            { label: "Σίγουρο λάθος — απαιτείται διόρθωση", desc: "Ο νέος ΚΑΔ 2025 προφανώς δεν ταιριάζει. Πρέπει να υποβληθεί αίτηση διόρθωσης.", color: "var(--danger)" },
          ].map((cat) => (
      ...
      <section className="card" style={{ marginBottom: "1.5rem" }}>
        ...
        <p style={{ lineHeight: 1.8 }}>
          Η προθεσμία χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026) είναι η <strong>30 Οκτωβρίου 2026</strong>. Μετά από αυτή την
