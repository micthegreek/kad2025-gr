  ...
  return (
    <div style={{ maxWidth: 860, margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      <div style={{ background: "var(--warn-bg)", border: "1px solid var(--warn-border)", borderRadius: "var(--radius)", padding: "1rem", marginBottom: "1.5rem" }}>
        <strong style={{ color: "var(--warn-strong)" }}>⚠️ Σημαντική επισήμανση:</strong>
      ...
      <section className="card" style={{ marginBottom: "1.5rem" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(160px, 1fr))", gap: "0.75rem", marginBottom: "1rem" }}>
          {[
            { rate: "24%", label: "Κανονικός", desc: "Γενική εφαρμογή — εμπόριο, βιομηχανία, τεχνολογία, διαφήμιση, μηχανικοί", color: "var(--danger)" },
            { rate: "13%", label: "Μειωμένος", desc: "Τρόφιμα, εστίαση, ξενοδοχεία, αγροτικά προϊόντα, θεατρικά εισιτήρια", color: "var(--acc-amber)" },
            { rate: "6%", label: "Υπερμειωμένος", desc: "Φαρμακευτικά προϊόντα, βιβλία, ορισμένες κατηγορίες ιατρικού εξοπλισμού", color: "var(--success)" },
          ].map((s) => (
      ...
      <section className="card" style={{ marginBottom: "1.5rem" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
          {[
            ...
            "Αν υπάρχει αμφιβολία, διορθώστε τον ΚΑΔ έως 30/10/2026 χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026)",
