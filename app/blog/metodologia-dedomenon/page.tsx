...
const faqItems = [
  ...
  },
  {
    ...
    a: "Ναι. Η απόφαση Α.1118/2026 παρέτεινε την προθεσμία διόρθωσης ΚΑΔ έως τις 30 Οκτωβρίου 2026 — όλες οι σελίδες του kad2025.gr αναφέρουν τη νέα προθεσμία. Οι ίδιες οι αντιστοιχίσεις (Α.1004/2026) δεν έχουν τροποποιηθεί.",
  },
  {
    ...
    <div className="post-layout">
      ...
      <section id="s4" className="card" style={{ marginBottom: "1.5rem", borderLeft: "4px solid var(--success, #16a34a)" }}>
        ...
        <p style={{ fontSize: "0.875rem", color: "var(--text-muted)", marginTop: "0.5rem", lineHeight: 1.7 }}>
          ...
          πρόστιμο έως τις <strong>30 Οκτωβρίου 2026</strong> (Α.1118/2026), μέσω της
      ...
      <section id="s5" className="card" style={{ marginBottom: "1.5rem" }}>
        ...
        <p style={{ lineHeight: 1.8, marginTop: "0.75rem", fontSize: "0.9rem" }}>
          Παράδειγμα από την πράξη: όταν εκδόθηκε η Α.1118/2026 με την παράταση της
