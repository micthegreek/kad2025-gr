      ...
      <section className="card" style={{ marginBottom: "1.5rem" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
          {[
            ...
            { step: "Βήμα 4", desc: "Ορίστε ημερομηνία μεταβολής — για αποφυγή προστίμου, επιλέξτε ημερομηνία εντός Μαρτίου-Οκτωβρίου 2026." },
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
          {[
            ...
            <div key={i} style={{ padding: "0.65rem 1rem", background: "var(--bg)", border: "1px solid var(--border)", borderRadius: 8 }}>
              <div style={{ fontWeight: 700, fontSize: "0.875rem", color: "var(--danger)", marginBottom: "0.2rem" }}>❓ {item.prob}</div>
