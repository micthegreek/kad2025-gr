    ...
    <div style={{ maxWidth: 860, margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      {[
        ...
        },
        {
          ...
          body: [
            "Η προθεσμία για έλεγχο και διόρθωση χωρίς πρόστιμο είναι η 30 Οκτωβρίου 2026 (Α.1118/2026). Πολλοί επιχειρηματίες αναβάλουν τον έλεγχο, πιστεύοντας ότι υπάρχει αρκετός χρόνος.",
