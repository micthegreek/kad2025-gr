    ...
    <div style={{ maxWidth: 860, margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      {[
        ...
        },
        {
          ...
          body: [
            "Η προθεσμία για έλεγχο και διόρθωση χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026) είναι η 30 Οκτωβρίου 2026 (Α.1118/2026). Πολλοί επιχειρηματίες αναβάλουν τον έλεγχο, πιστεύοντας ότι υπάρχει αρκετός χρόνος.",
      ...
      <section className="card" style={{ marginBottom: "1.5rem", background: "var(--success-bg)", border: "1px solid var(--success-border)" }}>
        <h2 style={{ fontSize: "1.05rem", marginBottom: "0.75rem", color: "var(--success-strong)" }}>✅ Συνοπτικές ενέργειες</h2>
        <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
          {[
            ...
            "Μη χάσετε την προθεσμία της 30ής Οκτωβρίου 2026 για αποφυγή προστίμου",
          ].map((item, i) => (
            <div key={i} style={{ display: "flex", gap: "0.5rem", alignItems: "flex-start", fontSize: "0.875rem", padding: "0.4rem 0.6rem", background: "var(--bg-card)", borderRadius: 6, border: "1px solid var(--success-border)" }}>
              <span style={{ color: "var(--success)", fontWeight: 700, flexShrink: 0 }}>✓</span>
              <span style={{ lineHeight: 1.6, color: "var(--success-text)" }}>{item}</span>
            </div>
          ))}
        </div>
      </section>
