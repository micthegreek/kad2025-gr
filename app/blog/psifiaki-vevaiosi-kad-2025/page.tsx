  ...
  return (
    <div style={{ maxWidth: 860, margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      <div style={{ display: "flex", gap: "0.5rem", alignItems: "center", marginBottom: "1rem", flexWrap: "wrap" }}>
        <span style={{ fontSize: "0.72rem", fontWeight: 700, padding: "0.2rem 0.6rem", borderRadius: 20, background: "var(--danger)", color: "white" }}>🔴 ΝΕΟ</span>
        <span style={{ fontSize: "0.72rem", fontWeight: 700, padding: "0.2rem 0.6rem", borderRadius: 20, background: "var(--info-strong)", color: "white" }}>Δελτίο Τύπου ΑΑΔΕ</span>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "0.75rem", marginBottom: "2rem" }}>
        {[
          { label: "ΑΦΜ με 1→1 αντιστοίχιση", value: "1.400.000", color: "var(--success)", note: "Καμία ενέργεια απαιτείται" },
          { label: "ΑΦΜ με 1→πολλά (one-to-many)", value: "510.000", color: "var(--danger)", note: "Χρειάζεται έλεγχος" },
          { label: "Προθεσμία (προς το παρόν)", value: "30/10/2026", color: "var(--acc-amber)", note: "Πιθανή παράταση" },
        ].map(s => (
      ...
      <section className="card" style={{ marginBottom: "1.5rem", borderLeft: "4px solid var(--info-strong)" }}>
        ...
        <div style={{ background: "var(--info-bg)", border: "1px solid var(--info-border)", borderRadius: 8, padding: "0.75rem 1rem", fontSize: "0.875rem" }}>
      ...
      <section className="card" style={{ marginBottom: "1.5rem" }}>
        ...
        <div style={{ background: "var(--warn-bg)", border: "1px solid var(--warn-border)", borderRadius: 8, padding: "0.75rem 1rem", fontSize: "0.875rem", color: "var(--warn-strong)" }}>
