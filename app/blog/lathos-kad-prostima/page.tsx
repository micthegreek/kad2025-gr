...
const faqItems = [
  {
    ...
    a: "Όχι. Με την απόφαση ΑΑΔΕ Α.1118/2026, οι διορθώσεις ΚΑΔ που σχετίζονται με τη μετάβαση στους ΚΑΔ 2025 γίνονται χωρίς πρόστιμο έως τις 30 Οκτωβρίου 2026, μέσω της εφαρμογής «Μεταβολή Εργασιών» στο myAADE.",
  },
  {
