...
const faqItems = [
  {
    ...
    a: "Όχι. Με την απόφαση ΑΑΔΕ Α.1118/2026, οι διορθώσεις ΚΑΔ που σχετίζονται με τη μετάβαση στους ΚΑΔ 2025 γίνονται χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026) έως τις 30 Οκτωβρίου 2026, μέσω της εφαρμογής «Μεταβολή Εργασιών» στο myAADE.",
  },
  {
  ...
  return (
    <div className="post-layout">
      ...
      <section id="s4" className="card" style={{ marginBottom: "1.5rem", borderLeft: "4px solid var(--success, #16a34a)" }}>
        ...
        <p style={{ lineHeight: 1.8, marginBottom: "0.75rem" }}>
          Με την απόφαση <strong>Α.1118/2026</strong>, η ΑΑΔΕ παρέτεινε την προθεσμία ελέγχου και
