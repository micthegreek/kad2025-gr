...
export const metadata: Metadata = {
  title: "Προθεσμία ΚΑΔ: 30 Οκτωβρίου 2026 | Πώς Κάνετε Διόρθωση",
  description:
    "Όλες οι σημαντικές ημερομηνίες για τους ΚΑΔ 2025. Πότε έγινε η αυτόματη αντιστοίχιση, μέχρι πότε μπορείτε να διορθώσετε χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026).",
...
const TIMELINE = [
  ...
  { date: "30 Οκτωβρίου 2026", label: "Λήξη περιόδου διόρθωσης", desc: "Τελευταία ημέρα για να διορθώσετε λανθασμένη αντιστοίχιση χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026).", status: "urgent", icon: "⏰" },
  { date: "Μετά 30/10/2026", label: "Κανονική λειτουργία", desc: "Ισχύουν κυρώσεις για αδήλωτες ή λανθασμένες δραστηριότητες.", status: "future", icon: "📋" },
];

const FAQS = [
  { q: "Τι γίνεται αν δεν κάνω τίποτα έως 30/10/2026;", a: "Αν η αυτόματη αντιστοίχιση της ΑΑΔΕ είναι σωστή, δεν χρειάζεται να κάνετε τίποτα. Αν όμως ο νέος ΚΑΔ δεν περιγράφει σωστά τη δραστηριότητά σας, πρέπει να διορθώσετε έως 30/10/2026 για να αποφύγετε κυρώσεις." },
  ...
  { q: "Ποια είναι η συνέπεια αν αλλάξω ΚΑΔ μετά την 30/10/2026;", a: "Μπορείτε να αλλάξετε ΚΑΔ και μετά την προθεσμία, αλλά ενδέχεται να επιβληθούν κυρώσεις για το διάστημα που ο ΚΑΔ ήταν λανθασμένος." },
];
...
export default function ProthesmiaPage() {
  return (
    <div style={{ maxWidth: 900, margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      <div style={{ background: "var(--warn-bg)", border: "1px solid var(--warn-border)", borderRadius: 8, padding: "0.75rem 1rem", marginBottom: "1.5rem", fontSize: "0.875rem", fontWeight: 600 }}>
      ...
      <div style={{ background: "var(--success-bg)", border: "2px solid var(--success)", borderRadius: "var(--radius)", padding: "1rem 1.25rem", marginBottom: "1.5rem" }}>
        ...
        <p style={{ fontSize: "0.875rem", lineHeight: 1.7, color: "var(--success-strong)", margin: "0 0 0.4rem" }}>
          Με την απόφαση <strong>Α.1118/2026</strong> του Διοικητή ΑΑΔΕ, η προθεσμία χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026) μετατέθηκε
        ...
        <p style={{ fontSize: "0.82rem", color: "var(--success-strong)", margin: 0 }}>
          Διαδρομή myAADE: <em>Μητρώο & Επικοινωνία → Αλλαγή Στοιχείων Μητρώου → Στοιχεία Επιχείρησης →
          Μεταβολή Στοιχείων Επιχείρησης → Αλλαγή Στοιχείων Εγκατάστασης Εσωτερικού</em>
        </p>
      </div>
      ...
      <p style={{ color: "var(--text-muted)", fontSize: "0.95rem", lineHeight: 1.7, marginBottom: "2rem" }}>
        ...
        <strong> 30 Οκτωβρίου 2026</strong> να ελέγξετε αν η αντιστοίχιση είναι σωστή και να διορθώσετε αν χρειάζεται.
      </p>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
          {TIMELINE.map((t) => (
            <div key={t.date} className="card" style={{
              ...
              borderLeft: `4px solid ${t.status === "done" ? "var(--success)" : t.status === "urgent" ? "var(--warn-border)" : "var(--border)"}`,
              opacity: t.status === "future" ? 0.7 : 1,
            }}>
              <span style={{ fontSize: "1.5rem", flexShrink: 0 }}>{t.icon}</span>
              <div>
                <div style={{ fontSize: "0.75rem", fontWeight: 700, color: t.status === "urgent" ? "var(--warn-strong)" : "var(--text-muted)", marginBottom: "0.15rem" }}>{t.date}</div>
