...
export const metadata: Metadata = {
  ...
  description:
    "Πότε πρέπει να διορθώσετε τον ΚΑΔ 2025 σας, πώς γίνεται η διαδικασία μέσω myAADE, τι έγγραφα χρειάζονται και ποια είναι η προθεσμία χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026).",
  ...
  "@graph": [
    {
      ...
      description: "Βήμα-βήμα οδηγός για διόρθωση ΚΑΔ χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026)",
    ...
    },
    {
      "@type": "FAQPage",
      mainEntity: [
        { "@type": "Question", name: "Μέχρι πότε μπορώ να διορθώσω χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026);", acceptedAnswer: { "@type": "Answer", text: "Έως 30 Οκτωβρίου 2026 (Α.1118/2026), μέσω Μεταβολής Εργασιών στο myaade.gov.gr." } },
  ...
  return (
    <div style={{ maxWidth: 860, margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      <div style={{ display: "flex", gap: "0.5rem", alignItems: "center", marginBottom: "1.5rem", flexWrap: "wrap" }}>
        <span style={{ fontSize: "0.75rem", fontWeight: 700, padding: "0.15rem 0.5rem", borderRadius: 20, background: "var(--acc-amber)", color: "white" }}>Πρακτικός Οδηγός</span>
      ...
      <p style={{ fontSize: "1rem", lineHeight: 1.8, color: "var(--text-muted)", marginBottom: "2rem", borderLeft: "3px solid var(--primary)", paddingLeft: "1rem" }}>
        ...
        αντιστοίχισης ΚΑΔ χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026). Ορίστε πότε χρειάζεται και πώς γίνεται η διαδικασία.
      </p>
      ...
      <div style={{ background: "var(--warn-bg)", border: "2px solid var(--warn-border)", borderRadius: "var(--radius)", padding: "1rem 1.25rem", marginBottom: "1.5rem", display: "flex", gap: "0.75rem", alignItems: "flex-start" }}>
        ...
        <div>
          ...
          <div style={{ fontSize: "0.875rem", color: "var(--warn-text)", lineHeight: 1.6 }}>
            Η διόρθωση ΚΑΔ χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026) ισχύει μέχρι αυτή την ημερομηνία.
      ...
      <section className="card" style={{ marginBottom: "1.5rem" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "0.75rem" }}>
          {[
            { label: "Κόστος διαδικασίας", value: "Δωρεάν", note: "Η ΑΑΔΕ δεν χρεώνει", color: "var(--success)" },
            { label: "Προθεσμία χωρίς πρόστιμο (εφόσον δεν έχει προηγηθεί δήλωση μεταβολής ΚΑΔ για την έδρα ή υποκατάστημα μετά την 1/3/2026, βάσει Α.1118/2026)", value: "30/10/2026", note: "Μετά ισχύουν κυρώσεις", color: "var(--danger)" },
            { label: "Χρόνος διεκπεραίωσης", value: "1-3 εργάσιμες", note: "Ψηφιακά μέσω myAADE", color: "var(--info-strong)" },
            { label: "Κόστος λογιστή", value: "Διαφέρει", note: "Ρωτήστε τον λογιστή σας", color: "var(--acc-amber)" },
          ].map((item) => (
      ...
      <section className="card" style={{ marginBottom: "1.5rem" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0.875rem" }}>
          {[
            ...
            { q: "Τι γίνεται αν η προθεσμία 30/10/2026 παρέλθει χωρίς διόρθωση;", a: "Μπορείτε να κάνετε τη διόρθωση και μετά, αλλά με τις τακτικές κυρώσεις για εκπρόθεσμη μεταβολή. Το ύψος του προστίμου εξαρτάται από την καθυστέρηση." },
      ...
      <div style={{ background: "var(--warn-bg)", border: "1px solid var(--warn-border)", borderRadius: "var(--radius)", padding: "0.75rem 1rem", fontSize: "0.82rem", color: "var(--warn-text)" }}>
        ...
        Για επίσημες ενέργειες: <a href="https://myaade.gov.gr" target="_blank" rel="noopener noreferrer" style={{ color: "var(--warn-strong)", fontWeight: 600 }}>myaade.gov.gr</a>.
      </div>
    </div>
  );
}
