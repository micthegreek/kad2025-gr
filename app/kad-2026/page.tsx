...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Νέοι ΚΑΔ 2026: Πίνακας, Δωρεάν Excel & Αντιστοίχιση',
    description:
      'Όλα όσα πρέπει να ξέρεις για τον νέο ΚΑΔ που ισχύει από 30 Οκτωβρίου 2026. Δωρεάν εργαλείο αντιστοίχισης.',
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Με τον όρο "ΚΑΔ 2026" αναφέρονται πολλοί χρήστες στον νέο πίνακα Κωδικών Αριθμών Δραστηριότητας που ισχύει υποχρεωτικά από την 30 Οκτωβρίου 2026, σύμφωνα με την Απόφαση Α.1003/2026. Επίσημα ο πίνακας ονομάζεται "ΚΑΔ 2025" επειδή θεσμοθετήθηκε εντός του 2025, αλλά η εφαρμογή του ξεκινά μέσα στο 2026.',
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Ο νέος πίνακας ΚΑΔ ισχύει υποχρεωτικά από την 30 Οκτωβρίου 2026 για όλες τις επιχειρήσεις και τους ελεύθερους επαγγελματίες στην Ελλάδα.',
        },
      },
      {
        '@type': 'Question',
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Ναι, πρόκειται για τον ίδιο πίνακα ΚΑΔ. Η ονομασία "ΚΑΔ 2025" αναφέρεται στο έτος θεσμοθέτησης ενώ η ονομασία "ΚΑΔ 2026" αναφέρεται στο έτος εφαρμογής (30 Οκτωβρίου 2026).',
        },
      },
    ],
  };
  ...
  return (
    <>
      ...
      <main style={styles.container}>
        <article>
          <h1 style={styles.h1}>
            ΚΑΔ 2026 — Ο Νέος Πίνακας ΚΑΔ που Ισχύει από 30 Οκτωβρίου 2026
          </h1>
          ...
          <div style={styles.summaryBox}>
            ...
            από την <strong>30 Οκτωβρίου 2026</strong>. Επίσημα ονομάζεται
            &quot;ΚΑΔ 2025&quot;.
          </div>
