...
export const metadata: Metadata = {
  ...
  description:
    'ΚΑΔ 2026: Ο νέος πίνακας ΚΑΔ (επίσημα «ΚΑΔ 2025») που ισχύει από 1η Μαρτίου 2026 σύμφωνα με την Α.1003/2026. Βρες σε ποιον νέο ΚΑΔ αντιστοιχεί ο παλιός σου με δωρεάν εργαλείο αντιστοίχισης.',
  keywords: [
    'ΚΑΔ 2026',
    'καδ 2026',
    'kad 2026',
    ...
    'πίνακας ΚΑΔ 2026',
    'αντιστοίχιση ΚΑΔ',
    'ΚΑΔ προθεσμία 30 Οκτωβρίου 2026',
    'Α.1003/2026',
  ],
  alternates: {
  ...
  openGraph: {
    title: 'Νέοι ΚΑΔ 2026: Πίνακας, Δωρεάν Excel & Αντιστοίχιση',
    description:
      'Όλα όσα πρέπει να ξέρεις για τον νέο πίνακα ΚΑΔ που ισχύει από 1η Μαρτίου 2026. Δωρεάν εργαλείο αντιστοίχισης.',
...
export default function Kad2026Page() {
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Ο όρος "ΚΑΔ 2026" χρησιμοποιείται συχνά στις αναζητήσεις για τους ΚΑΔ 2025 — τον νέο πίνακα Κωδικών Αριθμών Δραστηριότητας που ισχύει από την 1η Μαρτίου 2026, σύμφωνα με την Απόφαση Α.1003/2026. Επίσημα ονομάζεται "ΚΑΔ 2025" από την ονομασία της ονοματολογίας (ΚΑΔ 2025), ενώ η θεσμοθέτηση έγινε με την Α.1003/2026, ενώ η εφαρμογή του ξεκίνησε το 2026.',
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Ο νέος πίνακας ΚΑΔ ισχύει από την 1η Μαρτίου 2026 για όλες τις επιχειρήσεις και τους ελεύθερους επαγγελματίες στην Ελλάδα. Η 30ή Οκτωβρίου 2026 δεν είναι ημερομηνία έναρξης, αλλά η προθεσμία διόρθωσης της αυτόματης αντιστοίχισης (Α.1118/2026).',
        },
      },
      {
        '@type': 'Question',
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Ναι, πρόκειται για τον ίδιο πίνακα ΚΑΔ. Η ονομασία "ΚΑΔ 2025" αναφέρεται στο έτος θεσμοθέτησης, ενώ ο όρος "ΚΑΔ 2026" χρησιμοποιείται ανεπίσημα επειδή η εφαρμογή ξεκίνησε την 1η Μαρτίου 2026.',
        },
      },
    ],
  };
  ...
  const styles = {
    ...
    summaryBox: {
      ...
      borderLeft: '4px solid var(--info-strong)',
      padding: '16px 20px',
      borderRadius: '6px',
      margin: '0 0 28px 0',
      fontSize: '1.05rem',
      ...
      <div style={styles.container}>
        <article>
          ...
          <div style={styles.summaryBox}>
            ...
            <strong>Α.1003/2026</strong> και ισχύει από την
            <strong>1η Μαρτίου 2026</strong>. Επίσημα ονομάζεται
            &quot;ΚΑΔ 2025&quot;.
          </div>
          ...
          <p style={styles.paragraph}>
            ...
            <strong>υποχρεωτική ισχύς του</strong> ξεκίνησε την{' '}
            <strong>1η Μαρτίου 2026</strong> — γι&apos; αυτό πολλοί τον
          ...
          <h2 style={styles.h2}>Τι πρέπει να κάνεις έως την 30 Οκτωβρίου 2026 (προθεσμία διόρθωσης)</h2>
          ...
          <details style={styles.faqItem}>
            ...
            <p style={styles.faqAnswer}>
              Ναι. Ο νέος πίνακας ισχύει από την 1η Μαρτίου 2026 και όλες οι
              επιχειρήσεις έχουν ήδη ΚΑΔ από αυτόν, μετά την αυτόματη
              αντιστοίχιση της ΑΑΔΕ. Η 30ή Οκτωβρίου 2026 είναι η προθεσμία
              διόρθωσης της αντιστοίχισης, όχι ημερομηνία έναρξης ισχύος. Η μετάβαση γίνεται σε αρκετές
