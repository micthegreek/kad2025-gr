    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Ο όρος "ΚΑΔ 2026" χρησιμοποιείται συχνά στις αναζητήσεις για τους ΚΑΔ 2025 — τον νέο πίνακα Κωδικών Αριθμών Δραστηριότητας που ισχύει από την 1η Μαρτίου 2026, σύμφωνα με την Απόφαση Α.1003/2026. Επίσημα ονομάζεται "ΚΑΔ 2025" επειδή θεσμοθετήθηκε εντός του 2025, ενώ η εφαρμογή του ξεκίνησε το 2026.',
        },
      },
      {
        '@type': 'Question',
