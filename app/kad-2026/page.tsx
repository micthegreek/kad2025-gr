      ...
      <main style={styles.container}>
        <article>
          ...
          <p style={styles.paragraph}>
            ...
            <strong>30 Οκτωβρίου 2026</strong> — γι&apos; αυτό πολλοί τον
          ...
          <h2 style={styles.h2}>Τι πρέπει να κάνεις πριν την 30 Οκτωβρίου 2026</h2>
          ...
          <details style={styles.faqItem}>
            ...
            <p style={styles.faqAnswer}>
              Ναι, από την 30 Οκτωβρίου 2026 όλες οι επιχειρήσεις πρέπει να
